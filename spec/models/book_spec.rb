...
RSpec.describe Book, type: :model do
  ...
  describe '#status_for' do
    ...
    context 'when book is already loaned by user' do
      ...
      specify { expect(book.status_for(user)).to eql("loaned (due date: #{1.day.from_now.to_datetime.to_fs(:rfc822)}) by you") }
      ...
      context 'when book is also reserved by another user' do
        ...
        specify do
          expect(book.status_for(user)).to eql("loaned (due date: #{1.day.from_now.to_datetime.to_fs(:rfc822)}) by you; reserved")
        end
      end
    end
    ...
    context 'when book is already loaned by another user' do
      ...
      specify { expect(book.status_for(user)).to eql("loaned (due date: #{1.day.from_now.to_datetime.to_fs(:rfc822)})") }
      ...
      context 'when book is also reserved by you' do
        ...
        specify do
          expect(book.status_for(user)).to eql("loaned (due date: #{1.day.from_now.to_datetime.to_fs(:rfc822)}); reserved by you")
        end
      end
    end
  end
